...
balancelab ships an MCP server that exposes its core operations as native Claude tools.
...
balancelab is listed on [smithery.ai](https://smithery.ai) — search for "balancelab" to install with one click.
